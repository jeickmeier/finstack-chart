//! FIX-GG09 native univariate and target proof.
#[path = "../../common/ggplot_univariate_controls.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let plots = [0, 1, 2, 3, 5, 7]
        .into_iter()
        .map(|mode| Ok((format!("Univariate {mode}"), fixtures::author(mode)?)))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Distribution Recipes".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
