//! SP-07: actual native numeric, categorical, classifier, diverging and time guides.
#[path = "../../common/scale_fixtures.rs"]
mod fixtures;
            ...
            .child(
                div()
                    ...
                    .children(self.charts.iter().map(|(name, chart)| {
                        div()
                            .w(px(if name == "local-time" { 840. } else { 420. }))
                            .h(px(346.))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("Scale Integration Proof".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
