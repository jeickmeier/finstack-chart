//! FIX-GG05 composed guide native proof.
#[path = "../../common/ggplot_guide_composition.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let plots = [5, 7, 8, 9]
        .into_iter()
        .map(|mode| Ok((format!("Guide composition {mode}"), fixtures::author(mode)?)))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Composed Guide Proof".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
