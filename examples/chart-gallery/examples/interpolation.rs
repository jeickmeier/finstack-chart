//! ITP-07 native explicit interpolation sample.
#[path = "../../common/interpolation_fixtures.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let t = std::env::args()
        ...
        .transpose()?
        .unwrap_or(0.5);
    let plot = fixtures::figure(t, true)?;
    let bytes =
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some(format!("Interpolation Proof / native-only / t = {t}").into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
