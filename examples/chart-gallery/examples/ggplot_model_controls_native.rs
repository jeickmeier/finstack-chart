//! FIX-GG10 native recipe and target proof.
#[path = "../../common/ggplot_model_controls.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let plots = [0, 1, 2, 3, 7, 8]
        .into_iter()
        .map(|mode| Ok((format!("Model {mode}"), fixtures::author(mode)?)))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Model Controls".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
