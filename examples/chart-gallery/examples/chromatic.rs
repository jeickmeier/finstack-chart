//! FIX-21: actual native named categorical, Brewer, lookup, diverging and cyclic palettes.
#[path = "../../common/chromatic_fixtures.rs"]
mod fixtures;
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("Chromatic Catalog Proof".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
