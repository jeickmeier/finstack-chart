//! FIX-GG11 native spatial and target proof.
#[allow(dead_code)]
#[path = "../../common/ggplot_spatial_controls.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let plots = [0, 2, 4, 5, 7, 10]
        .into_iter()
        .map(|mode| Ok((format!("Spatial {mode}"), fixtures::author(mode)?)))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Spatial Controls".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
