//! FIX-GG07 native intervals, steps and arrows proof.
#[path = "../../common/ggplot_interval_recipes.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let plots = [2, 3, 6, 11, 15, 16]
        .into_iter()
        .map(|mode| Ok((format!("Interval {mode}"), fixtures::author(mode)?)))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Interval Recipes".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
