...
#[path = "../../common/ggplot_position_controls.rs"]
mod fixtures;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let plots = [1, 3, 4, 5, 6, 7]
        .into_iter()
        .map(|mode| Ok((fixtures::name(mode).to_owned(), fixtures::author(mode)?)))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Position Proof".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
