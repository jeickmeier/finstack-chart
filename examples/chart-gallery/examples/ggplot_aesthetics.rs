//! FIX-GG03 native reference glyphs using the shared chart engine.
#[path = "../../common/ggplot_aesthetic_fixtures.rs"]
mod fixtures;
...
impl Render for Gallery {
    fn render(&mut self, _: &mut Window, _: &mut Context<Self>) -> impl IntoElement {
        div()
            ...
            .child(div().w(px(640.)).h(px(400.)).child(self.chart.clone()))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("GGplot Aesthetic Proof".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
