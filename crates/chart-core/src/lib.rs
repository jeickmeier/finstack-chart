...
pub mod prelude {
    ...
    pub use crate::plot::{
        ...
        color_mapped, column, connect_stat, count, crossbar, custom_stat, density, density_stat,
        ...
        histogram, hline, identity_stat, inset, jitter, labels, layout_options, legend, line,
        linerange, link, model_stat, nudge, nullable_timestamps, number_format, ohlc, panel_letter,
        plot, pointrange, points, qq, qq_line, qq_line_stat, qq_stat, quantile, quantile_stat,
        rectangle, render_options, ribbon, rich_text, rule, scale_aes, scale_band, scale_binned,
        scale_calendar, scale_date, scale_duration, scale_linear, scale_log, scale_numeric,
        scale_point, scale_registered, scale_reverse, scale_session, scale_sqrt, scale_symlog,
        scale_utc, segment, smooth, smooth_stat, source_expr, source_note, stack, stat_aes, step,
        stream_options, style, subtitle, summary, text_run, text_style, theme, time_value,
        timestamps, title, transform, unique_stat, univariate_stat, violin, violin_stat, vline,
        volume, x_axis, xlim, y_axis, ylim,
    };
