...
pub mod prelude {
    ...
    pub use crate::plot::{
        ...
        annotation_edit, area, axis_guide, bars, bin, bin_aes, bin2d, bin2d_stat, blank, boxplot,
        boxplot_stat, callout, caption, categorical, cells, color_continuous, color_discrete,
        color_mapped, column, connect_stat, contour, contour_filled, contour_filled_stat,
        contour_stat, count, crossbar, custom_stat, density, density_stat, density2d,
        density2d_stat, distribution_stat, dodge, dodge2, dotplot, dotplot_stat, ecdf, ecdf_stat,
        ellipse, ellipse_stat, errorbar, facet_grid, facet_wrap, filter, fit, footnote, from_theme,
        function_curve, function_stat, ggplot_dodge, ggplot_fill, ggplot_stack, hex, hex_stat,
        hierarchy, hierarchy_cluster, hierarchy_icicle, hierarchy_pack, hierarchy_sunburst,
        hierarchy_tree, hierarchy_treemap, histogram, hline, identity_stat, inset, jitter,
        jitter_dodge, labels, layout_options, legend, line, linerange, link, model_stat, nudge,
        nullable_timestamps, number_format, ohlc, panel_letter, plot, pointrange, points, qq,
        qq_line, qq_line_stat, qq_stat, quantile, quantile_stat, rectangle, render_options, ribbon,
        ...
        shape_link_vertical, shape_pie, shape_stack, shape_symbol, smooth, smooth_stat,
        source_expr, source_note, spatial_stat, stack, stat_aes, step, stream_options, style,
        subtitle, summary, text_run, text_style, theme, time_value, timestamps, title, transform,
        unique_stat, univariate_stat, violin, violin_stat, vline, volume, x_axis, xlim, y_axis,
        ylim,
    };
    pub use crate::plot::{AuthoringInput, AuthoringSelection, CustomAuthoring, autoplot};
    pub use crate::plot::{
        CutOptions, CutResult, CutSpec, ResolutionOptions, VectorPathBuilder, cut, math_text,
        resolution, summarize, vector_path,
    };
