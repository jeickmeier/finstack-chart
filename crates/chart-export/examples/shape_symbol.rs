//! Actual all-symbol, multi-size, all-theme immutable publication.
#[path = "../../../examples/common/shape_symbol_fixtures.rs"]
mod fixtures;
use chart_export::*;
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "PASS symbol publication: all 13 geometries, three sizes, type/size guides, three themes, source anchors and 300/600 DPI outputs."
    );
    Ok(())
}
