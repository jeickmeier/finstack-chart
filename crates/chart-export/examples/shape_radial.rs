//! Actual radial/link publication in all themes.
#[path = "../../../examples/common/shape_radial_fixtures.rs"]
mod fixtures;
use chart_export::*;
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "PASS radial publication: signed radii, gaps, paired areas, four link routes, source anchors, three themes and 300/600 DPI outputs."
    );
    Ok(())
}
