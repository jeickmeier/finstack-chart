...
jsonlite::write_json(list(reference='ggplot2 4.0.3',cases=cases),'fixtures/parity/ggplot2/positional-pipeline-facets.json',auto_unbox=TRUE,pretty=TRUE,digits=15,null='null',na='null')
dev.off()
