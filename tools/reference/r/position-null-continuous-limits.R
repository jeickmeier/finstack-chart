...
for (continuous in names(continuous_sets)) for (expansion_name in names(expansions)) {
...
jsonlite::write_json(list(reference = 'ggplot2 4.0.3 / R 4.6.1', cases = cases),
  'fixtures/parity/ggplot2/position-null-continuous-limits.json', auto_unbox = TRUE,
