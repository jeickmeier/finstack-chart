...
jsonlite::write_json(list(reference='ggplot2 4.0.3 / R 4.6.1',cases=cases),'fixtures/parity/ggplot2/vector-palette-missing-paint.json',auto_unbox=TRUE,pretty=TRUE,digits=NA,null='null')
