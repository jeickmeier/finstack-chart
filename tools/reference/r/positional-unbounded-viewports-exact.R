# FIX-GG04: exact coordinate views over unbounded position scales; expansion is explicitly disabled.
...
jsonlite::write_json(list(reference='ggplot2 4.0.3 / R 4.6.1',cases=cases),'fixtures/parity/ggplot2/positional-unbounded-viewports-exact.json',auto_unbox=TRUE,pretty=TRUE,digits=17,null='null',na='null')
