...
class Chart {
    ...
    action(input) {
        ...
        try {
            ...
            const ret = wasm.chart_action(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    definition() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.chart_definition(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    dispose() {
        wasm.chart_dispose(this.__wbg_ptr);
    }
    /**
     ...
     */
    constructor(definition, data, profile, font) {
        const ptr0 = passStringToWasm0(definition, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(profile, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(font, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.chart_new(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[2]) {
    ...
    restore_state(input, expected) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.chart_restore_state(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
    ...
    scene() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.chart_scene(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    semantics() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.chart_semantics(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    state() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.chart_state(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    svg() {
        const ret = wasm.chart_svg(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
    ...
    transaction(input) {
        ...
        try {
            const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.chart_transaction(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
const wasmPath = `${__dirname}/chart_wasm_bg.wasm`;
