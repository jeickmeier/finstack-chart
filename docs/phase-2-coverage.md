...
| Independent aesthetic mappings and units | GG2-03 | GG-03 | A-MAPPING, A-GEOM | FIX-GG03 | C/D | COMPLETE for GG-03: independently trained channels, area/radius/width separation, R glyphs, units and actual hosts; [evidence](evidence/phase-2-aesthetics-2026-09-10.md). Palette/scale policies remain GG-04. |
| Scale, palette, limits, breaks and secondary policies | GG2-03 | GG-04 | A-SCALE, A-COLOR, A-AXIS | FIX-GG04 | S/C/D | IN PROGRESS: shared palette/scale/break/label kernels, numeric/discrete expansion, primary style defaults and reverse/square-root positional transforms pass scoped R comparisons; date/time, secondary policies and full acceptance remain. [Evidence](evidence/phase-2-ggplot-scales-2026-09-10.md). |
