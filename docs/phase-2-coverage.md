...
| Scale, palette, limits, breaks and secondary policies | GG2-03 | GG-04 | A-SCALE, A-COLOR, A-AXIS | FIX-GG04 | S/C/D | IN PROGRESS: shared palette/scale/break/label kernels and discrete/binned/continuous palette callbacks pass scoped reference and actual-host checks; constructor reconciliation and cumulative acceptance remain. [Evidence](evidence/phase-2-ggplot-scales-2026-09-10.md). |
