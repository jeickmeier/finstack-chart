...
def wasm_module(root, output, target, run, cli):
    ...
    for name in ('authoring.cjs', 'authoring.d.cts', 'interpolation.cjs', 'interpolation.d.cts', 'scales.cjs', 'scales.d.cts', 'examples.cjs', 'examples.d.cts', 'hierarchy.cjs', 'hierarchy.d.cts'):
