"""FIX-S07/09 independent host scenes and publication artifacts at both resolutions."""
...
(root/'comparison.json').write_text(json.dumps(records,indent=2)+'\n');print('PASS stack comparison: three hosts, three themes, two resolutions, complete scene metadata and exact PNG/PDF bytes; SVG equality and any coordinate differences recorded. Visual/native inspection is separate.')
