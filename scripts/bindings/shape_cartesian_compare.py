"""FIX-S02/03 identical independently authored shapes through all three runtime scenes."""
...
print('PASS FIX-S02/03: identical full scenes and PNG bytes across Rust/Python/WASM at 300/600 DPI. Native/SVG/PDF inspection is separate.')
